      ...
      <div className={kokatooStyles.navContainer}>
        ...
        <div className={kokatooStyles.v}>
          ...
          <div className={kokatooStyles.tagImg}>
            <div className={kokatooStyles.tagImgContainer}>
              <img src={relatedImg} alt="연관키워드" id={kokatooStyles.relatedImg}></img>
              <span>연관키워드</span>
            </div>
          </div>
          <div className={kokatooStyles.numOfSearchResults}>
            <div>
              <span id={kokatooStyles.number}>31</span>
              <span id={kokatooStyles.numberExplanation}>개의 검색결과</span>
            </div>
            <div>
        ...
        <div className={kokatooStyles.posts}>
          {list.map((post) => (
            <>
              ...
              <div className={kokatooStyles.postContainer}>
                <Link to={post.link} style={{ width: 'auto', height: 'auto' }}>
